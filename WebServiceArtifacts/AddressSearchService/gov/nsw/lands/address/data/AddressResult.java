...
import gov.nsw.lands.address.ws.ArrayOfTns2NillableAddressRecord;


/**
 * <p>Java class for AddressResult complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="addresses" type="{http://ws.address.lands.nsw.gov}ArrayOf_tns2_nillable_AddressRecord"/>
...
@XmlType(name = "AddressResult", propOrder = {
    "addresses",
    "errMsg",
    "numRecs",
    "searchMethod"
...
public class AddressResult {
    ...
    protected ArrayOfTns2NillableAddressRecord addresses;
    @XmlElement(required = true, nillable = true)
     ...
     * @return
     *     possible object is
     *     {@link ArrayOfTns2NillableAddressRecord }
     *     
     */
    public ArrayOfTns2NillableAddressRecord getAddresses() {
        return addresses;
    }
     ...
     *     
     */
    public void setAddresses(ArrayOfTns2NillableAddressRecord value) {
