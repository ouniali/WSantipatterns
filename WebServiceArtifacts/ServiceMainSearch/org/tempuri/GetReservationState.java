...
@XmlRootElement(name = "GetReservationState")
public class GetReservationState {

    @XmlElementRef(name = "reservationCode", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> reservationCode;
     ...
     *     
     */
    public JAXBElement<String> getReservationCode() {
     ...
     *     
     */
    public void setReservationCode(JAXBElement<String> value) {
