 ...
 * 
 */
@WebServiceClient(name = "GlobalWeather", targetNamespace = "http://www.webserviceX.NET", wsdlLocation = "META-INF/wsdl/service37.wsdl")
    ...
    extends Service
{
    ...
    static {
        GLOBALWEATHER_WSDL_LOCATION = net.webservicex.GlobalWeather.class.getClassLoader().getResource("META-INF/wsdl/service37.wsdl");
        WebServiceException e = null;
        if (GLOBALWEATHER_WSDL_LOCATION == null) {
            e = new WebServiceException("Cannot find 'META-INF/wsdl/service37.wsdl' wsdl. Place the resource correctly in the classpath.");
        }
