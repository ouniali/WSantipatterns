 ...
 * 
 */
@WebService(name = "AirExchangeTicketingPortType", targetNamespace = "http://www.travelport.com/service/air_v18_0")
...
public interface AirExchangeTicketingPortType {
     ...
     * @param parameters
     * @return
     *     returns com.travelport.schema.air_v18_0.AirExchangeTicketingRsp
    ...
    public AirExchangeTicketingRsp service(
        @WebParam(name = "AirExchangeTicketingReq", targetNamespace = "http://www.travelport.com/schema/air_v18_0", partName = "parameters")
