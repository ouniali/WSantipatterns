 ...
 * 
 */
@WebService(name = "AirFareRulesPortType", targetNamespace = "http://www.travelport.com/service/air_v18_0")
...
public interface AirFareRulesPortType {
     ...
     * @param parameters
     * @return
     *     returns com.travelport.schema.air_v18_0.AirFareRulesRsp
    ...
    public AirFareRulesRsp service(
        @WebParam(name = "AirFareRulesReq", targetNamespace = "http://www.travelport.com/schema/air_v18_0", partName = "parameters")
