 ...
 * 
 */
@WebService(name = "FlightInfoPortType", targetNamespace = "http://www.travelport.com/service/air_v18_0")
...
public interface FlightInfoPortType {
     ...
     * @param parameters
     * @return
     *     returns com.travelport.schema.air_v18_0.FlightInformationRsp
    ...
    public FlightInformationRsp service(
        @WebParam(name = "FlightInformationReq", targetNamespace = "http://www.travelport.com/schema/air_v18_0", partName = "parameters")
