 ...
 * 
 */
@WebService(name = "AirCreateReservationPortType", targetNamespace = "http://www.travelport.com/service/air_v18_0")
...
public interface AirCreateReservationPortType {
     ...
     * @param parameters
     * @return
     *     returns com.travelport.schema.air_v18_0.AirCreateReservationRsp
     * @throws AvailabilityFaultMessage
    ...
    public AirCreateReservationRsp service(
        @WebParam(name = "AirCreateReservationReq", targetNamespace = "http://www.travelport.com/schema/air_v18_0", partName = "parameters")
        AirCreateReservationReq parameters)
