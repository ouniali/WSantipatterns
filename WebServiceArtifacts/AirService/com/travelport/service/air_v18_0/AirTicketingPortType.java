...
import com.travelport.schema.air_v18_0.AirTicketingReq;
 ...
 * 
 */
@WebService(name = "AirTicketingPortType", targetNamespace = "http://www.travelport.com/service/air_v18_0")
...
public interface AirTicketingPortType {
     ...
     * @param parameters
     * @return
     *     returns com.travelport.schema.air_v18_0.AirTicketingRsp
    ...
    public AirTicketingRsp service(
        @WebParam(name = "AirTicketingReq", targetNamespace = "http://www.travelport.com/schema/air_v18_0", partName = "parameters")
