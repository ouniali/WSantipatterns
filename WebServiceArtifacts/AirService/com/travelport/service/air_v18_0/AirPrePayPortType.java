 ...
 * 
 */
@WebService(name = "AirPrePayPortType", targetNamespace = "http://www.travelport.com/service/air_v18_0")
...
public interface AirPrePayPortType {
     ...
     * @param parameters
     * @return
     *     returns com.travelport.schema.air_v18_0.AirPrePayRsp
    ...
    public AirPrePayRsp service(
        @WebParam(name = "AirPrePayReq", targetNamespace = "http://www.travelport.com/schema/air_v18_0", partName = "parameters")
