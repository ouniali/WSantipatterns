 ...
 * 
 */
@WebService(name = "AirCancelPortType", targetNamespace = "http://www.travelport.com/service/air_v18_0")
...
public interface AirCancelPortType {
     ...
     * @param parameters
     * @return
     *     returns com.travelport.schema.air_v18_0.AirCancelRsp
    ...
    public AirCancelRsp service(
        @WebParam(name = "AirCancelReq", targetNamespace = "http://www.travelport.com/schema/air_v18_0", partName = "parameters")
        AirCancelReq parameters)
        throws AirFaultMessage
    ;
