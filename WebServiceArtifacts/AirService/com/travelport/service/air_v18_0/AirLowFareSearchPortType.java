...
import com.travelport.schema.air_v18_0.LowFareSearchRsp;
 ...
 * 
 */
@WebService(name = "AirLowFareSearchPortType", targetNamespace = "http://www.travelport.com/service/air_v18_0")
...
public interface AirLowFareSearchPortType {
     ...
     * @param parameters
     * @return
     *     returns com.travelport.schema.air_v18_0.LowFareSearchRsp
    ...
    public LowFareSearchRsp service(
        @WebParam(name = "LowFareSearchReq", targetNamespace = "http://www.travelport.com/schema/air_v18_0", partName = "parameters")
