 ...
 * 
 */
@WebService(name = "AirRefundTicketPortType", targetNamespace = "http://www.travelport.com/service/air_v18_0")
...
public interface AirRefundTicketPortType {
     ...
     * @param parameters
     * @return
     *     returns com.travelport.schema.air_v18_0.AirRefundRsp
    ...
    public AirRefundRsp service(
        @WebParam(name = "AirRefundReq", targetNamespace = "http://www.travelport.com/schema/air_v18_0", partName = "parameters")
