 ...
 * 
 */
@WebService(name = "AirExchangeQuotePortType", targetNamespace = "http://www.travelport.com/service/air_v18_0")
...
public interface AirExchangeQuotePortType {
     ...
     * @param parameters
     * @return
     *     returns com.travelport.schema.air_v18_0.AirExchangeQuoteRsp
    ...
    public AirExchangeQuoteRsp service(
        @WebParam(name = "AirExchangeQuoteReq", targetNamespace = "http://www.travelport.com/schema/air_v18_0", partName = "parameters")
