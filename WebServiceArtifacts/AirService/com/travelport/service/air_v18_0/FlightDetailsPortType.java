 ...
 * 
 */
@WebService(name = "FlightDetailsPortType", targetNamespace = "http://www.travelport.com/service/air_v18_0")
...
public interface FlightDetailsPortType {
     ...
     * @param parameters
     * @return
     *     returns com.travelport.schema.air_v18_0.FlightDetailsRsp
    ...
    public FlightDetailsRsp service(
        @WebParam(name = "FlightDetailsReq", targetNamespace = "http://www.travelport.com/schema/air_v18_0", partName = "parameters")
