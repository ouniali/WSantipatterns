...
import com.travelport.schema.air_v18_0.AirRepriceReq;
 ...
 * 
 */
@WebService(name = "AirRepriceSearchPortType", targetNamespace = "http://www.travelport.com/service/air_v18_0")
...
public interface AirRepriceSearchPortType {
     ...
     * @param parameters
     * @return
     *     returns com.travelport.schema.air_v18_0.AirRepriceRsp
    ...
    public AirRepriceRsp service(
        @WebParam(name = "AirRepriceReq", targetNamespace = "http://www.travelport.com/schema/air_v18_0", partName = "parameters")
