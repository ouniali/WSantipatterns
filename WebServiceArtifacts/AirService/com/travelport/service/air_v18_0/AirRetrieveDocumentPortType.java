 ...
 * 
 */
@WebService(name = "AirRetrieveDocumentPortType", targetNamespace = "http://www.travelport.com/service/air_v18_0")
...
public interface AirRetrieveDocumentPortType {
     ...
     * @param parameters
     * @return
     *     returns com.travelport.schema.air_v18_0.AirRetrieveDocumentRsp
    ...
    public AirRetrieveDocumentRsp service(
        @WebParam(name = "AirRetrieveDocumentReq", targetNamespace = "http://www.travelport.com/schema/air_v18_0", partName = "parameters")
