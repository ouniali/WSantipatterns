 ...
 * 
 */
@WebService(name = "SeatMapPortType", targetNamespace = "http://www.travelport.com/service/air_v18_0")
...
public interface SeatMapPortType {
     ...
     * @param parameters
     * @return
     *     returns com.travelport.schema.air_v18_0.SeatMapRsp
    ...
    public SeatMapRsp service(
        @WebParam(name = "SeatMapReq", targetNamespace = "http://www.travelport.com/schema/air_v18_0", partName = "parameters")
