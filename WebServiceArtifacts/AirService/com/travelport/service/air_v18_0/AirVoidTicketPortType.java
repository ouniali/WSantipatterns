 ...
 * 
 */
@WebService(name = "AirVoidTicketPortType", targetNamespace = "http://www.travelport.com/service/air_v18_0")
...
public interface AirVoidTicketPortType {
     ...
     * @param parameters
     * @return
     *     returns com.travelport.schema.air_v18_0.AirVoidTicketRsp
    ...
    public AirVoidTicketRsp service(
        @WebParam(name = "AirVoidTicketReq", targetNamespace = "http://www.travelport.com/schema/air_v18_0", partName = "parameters")
        AirVoidTicketReq parameters)
        throws AirFaultMessage
    ;
