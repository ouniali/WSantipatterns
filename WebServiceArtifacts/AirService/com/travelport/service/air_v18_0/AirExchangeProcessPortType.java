 ...
 * 
 */
@WebService(name = "AirExchangeProcessPortType", targetNamespace = "http://www.travelport.com/service/air_v18_0")
...
public interface AirExchangeProcessPortType {
     ...
     * @param parameters
     * @return
     *     returns com.travelport.schema.air_v18_0.AirExchangeRsp
    ...
    public AirExchangeRsp service(
        @WebParam(name = "AirExchangeReq", targetNamespace = "http://www.travelport.com/schema/air_v18_0", partName = "parameters")
