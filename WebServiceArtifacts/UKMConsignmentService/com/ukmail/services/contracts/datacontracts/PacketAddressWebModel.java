...
/**
 * <p>Java class for PacketAddressWebModel complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PacketAddressWebModel">
 *   &lt;complexContent>
...
@XmlType(name = "PacketAddressWebModel", propOrder = {
    "address1",
    "address2",
    "address3",
    "county",
...
public class PacketAddressWebModel {

    @XmlElement(name = "Address1", required = true, nillable = true)
    protected String address1;
    @XmlElementRef(name = "Address2", namespace = "http://www.UKMail.com/Services/Contracts/DataContracts", type = JAXBElement.class, required = false)
    protected JAXBElement<String> address2;
    @XmlElementRef(name = "Address3", namespace = "http://www.UKMail.com/Services/Contracts/DataContracts", type = JAXBElement.class, required = false)
    protected JAXBElement<String> address3;
    @XmlElementRef(name = "County", namespace = "http://www.UKMail.com/Services/Contracts/DataContracts", type = JAXBElement.class, required = false)
    protected JAXBElement<String> county;
    @XmlElementRef(name = "PostalTown", namespace = "http://www.UKMail.com/Services/Contracts/DataContracts", type = JAXBElement.class, required = false)
