...
/**
 * <p>Java class for UKMAddInternationalConsignmentWebResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="UKMAddInternationalConsignmentWebResponse">
 *   &lt;complexContent>
 ...
 *         &lt;element name="InvoiceBytes" type="{http://www.w3.org/2001/XMLSchema}base64Binary" minOccurs="0"/>
...
@XmlType(name = "UKMAddInternationalConsignmentWebResponse", propOrder = {
    "consignmentNumber",
    "invoiceBytes",
    "labels"
})
public class UKMAddInternationalConsignmentWebResponse
    extends UKMWebResponse
{
    ...
    @XmlElementRef(name = "InvoiceBytes", namespace = "http://www.UKMail.com/Services/Contracts/DataContracts", type = JAXBElement.class, required = false)
    protected JAXBElement<byte[]> invoiceBytes;
    ...
    /**
     * Gets the value of the invoiceBytes property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<byte[]> getInvoiceBytes() {
        return invoiceBytes;
    }

    /**
     * Sets the value of the invoiceBytes property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link byte[]}{@code >}
     *     
     */
    public void setInvoiceBytes(JAXBElement<byte[]> value) {
        this.invoiceBytes = value;
    }
