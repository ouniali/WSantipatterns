...
/**
 * <p>Java class for AddConsignmentDeferredWebRequest complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AddConsignmentDeferredWebRequest">
 *   &lt;complexContent>
 ...
 *         &lt;element name="LabelFormat" type="{http://www.UKMail.com/Services/Contracts/DataContracts}LabelFormatType"/>
...
@XmlType(name = "AddConsignmentDeferredWebRequest", propOrder = {
    "accountNumber",
    "address",
    "alternativeRef",
    "businessName",
...
@XmlSeeAlso({
    AddDomesticConsignmentDeferredWebRequest.class
})
public class AddConsignmentDeferredWebRequest
    extends WebRequest
{
    ...
    protected int items;
    @XmlElement(name = "LabelFormat", required = true)
    @XmlSchemaType(name = "string")
    protected LabelFormatType labelFormat;
     ...
     *     
     */
    public LabelFormatType getLabelFormat() {
        return labelFormat;
    }
     ...
     *     
     */
    public void setLabelFormat(LabelFormatType value) {
