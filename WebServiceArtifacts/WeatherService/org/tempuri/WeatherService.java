 ...
 * 
 */
@WebServiceClient(name = "WeatherService", targetNamespace = "http://tempuri.org/", wsdlLocation = "META-INF/wsdl/15004_United_States_WeatherService.wsdl")
    ...
    extends Service
{
    ...
    static {
        WEATHERSERVICE_WSDL_LOCATION = org.tempuri.WeatherService.class.getClassLoader().getResource("META-INF/wsdl/15004_United_States_WeatherService.wsdl");
        WebServiceException e = null;
        if (WEATHERSERVICE_WSDL_LOCATION == null) {
            e = new WebServiceException("Cannot find 'META-INF/wsdl/15004_United_States_WeatherService.wsdl' wsdl. Place the resource correctly in the classpath.");
        }
    ...
    public WeatherServiceSoap getWeatherServiceSoap() {
        return super.getPort(new QName("http://tempuri.org/", "WeatherServiceSoap"), WeatherServiceSoap.class);
    }
    ...
    public WeatherServiceSoap getWeatherServiceSoap(WebServiceFeature... features) {
        return super.getPort(new QName("http://tempuri.org/", "WeatherServiceSoap"), WeatherServiceSoap.class, features);
    }
