 ...
 * 
 */
@WebServiceClient(name = "USWeather", targetNamespace = "http://www.webserviceX.NET", wsdlLocation = "META-INF/wsdl/service43.wsdl")
    ...
    extends Service
{
    ...
    static {
        USWEATHER_WSDL_LOCATION = net.webservicex.USWeather.class.getClassLoader().getResource("META-INF/wsdl/service43.wsdl");
        WebServiceException e = null;
        if (USWEATHER_WSDL_LOCATION == null) {
            e = new WebServiceException("Cannot find 'META-INF/wsdl/service43.wsdl' wsdl. Place the resource correctly in the classpath.");
        }
