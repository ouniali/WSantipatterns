 ...
 * 
 */
@WebServiceClient(name = "CurrencyConvertor", targetNamespace = "http://www.webserviceX.NET/", wsdlLocation = "META-INF/wsdl/10742_United_States_currencyconvertor.wsdl")
    ...
    extends Service
{
    ...
    static {
        CURRENCYCONVERTOR_WSDL_LOCATION = net.webservicex.CurrencyConvertor.class.getClassLoader().getResource("META-INF/wsdl/10742_United_States_currencyconvertor.wsdl");
        WebServiceException e = null;
        if (CURRENCYCONVERTOR_WSDL_LOCATION == null) {
            e = new WebServiceException("Cannot find 'META-INF/wsdl/10742_United_States_currencyconvertor.wsdl' wsdl. Place the resource correctly in the classpath.");
        }
