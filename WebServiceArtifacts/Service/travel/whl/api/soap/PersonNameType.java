 ...
 *       &lt;sequence>
 *         &lt;element name="NamePrefix" type="{http://api.whl.travel/soap}StringLength1to16" maxOccurs="3" minOccurs="0"/>
 *         &lt;element name="GivenName" type="{http://api.whl.travel/soap}StringLength1to64" maxOccurs="5" minOccurs="0"/>
 *         &lt;element name="MiddleName" type="{http://api.whl.travel/soap}StringLength1to64" maxOccurs="3" minOccurs="0"/>
 *         &lt;element name="SurnamePrefix" type="{http://api.whl.travel/soap}StringLength1to16" minOccurs="0"/>
 *         &lt;element name="Surname" type="{http://api.whl.travel/soap}StringLength1to64"/>
 *         &lt;element name="NameSuffix" type="{http://api.whl.travel/soap}StringLength1to16" maxOccurs="3" minOccurs="0"/>
 *         &lt;element name="NameTitle" type="{http://api.whl.travel/soap}StringLength1to16" maxOccurs="5" minOccurs="0"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{http://api.whl.travel/soap}PrivacyGroup"/>
 *       &lt;attribute name="NameType" type="{http://api.whl.travel/soap}OTA_CodeType" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlSeeAlso({
    travel.whl.api.soap.ContactsType.Name.class
})
