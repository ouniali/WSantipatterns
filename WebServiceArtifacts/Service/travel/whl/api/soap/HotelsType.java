 ...
 *       &lt;sequence>
 *         &lt;element name="Hotel" type="{http://api.whl.travel/soap}HotelInfoType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class HotelsType {
    ...
    protected List<HotelInfoType> hotel;
     ...
     * 
     */
    public List<HotelInfoType> getHotel() {
        if (hotel == null) {
            hotel = new ArrayList<HotelInfoType>();
        }
        return this.hotel;
    }
