 ...
 *           &lt;complexType>
 *             &lt;simpleContent>
 *               &lt;extension base="&lt;http://api.whl.travel/soap>StreetNmbrType">
 *                 &lt;attribute name="StreetNmbrSuffix" type="{http://api.whl.travel/soap}StringLength1to8" />
 *                 &lt;attribute name="StreetDirection" type="{http://api.whl.travel/soap}StringLength1to8" />
 *                 &lt;attribute name="RuralRouteNmbr" type="{http://api.whl.travel/soap}NumericStringLength1to5" />
 *               &lt;/extension>
 *             &lt;/simpleContent>
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="AddressLine" type="{http://api.whl.travel/soap}StringLength1to255" maxOccurs="5" minOccurs="0"/>
 *         &lt;element name="CityName" type="{http://api.whl.travel/soap}StringLength1to64" minOccurs="0"/>
 *         &lt;element name="PostalCode" type="{http://api.whl.travel/soap}StringLength1to16" minOccurs="0"/>
 *         &lt;element name="County" type="{http://api.whl.travel/soap}StringLength1to32" minOccurs="0"/>
 *         &lt;element name="StateProv" type="{http://api.whl.travel/soap}StateProvType" minOccurs="0"/>
 *         &lt;element name="CountryName" type="{http://api.whl.travel/soap}CountryNameType" minOccurs="0"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{http://api.whl.travel/soap}PrivacyGroup"/>
 *       &lt;attGroup ref="{http://api.whl.travel/soap}FormattedInd"/>
 *       &lt;attribute name="Type" type="{http://api.whl.travel/soap}OTA_CodeType" />
