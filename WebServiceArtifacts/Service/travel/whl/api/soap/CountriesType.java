 ...
 *       &lt;sequence>
 *         &lt;element name="CountryName" type="{http://api.whl.travel/soap}CountryNameType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CountriesType {
    ...
    protected List<CountryNameType> countryName;
     ...
     * 
     */
    public List<CountryNameType> getCountryName() {
        if (countryName == null) {
            countryName = new ArrayList<CountryNameType>();
        }
