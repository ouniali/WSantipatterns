 ...
 * 
 */
@WebServiceClient(name = "Service", targetNamespace = "http://accountapiv2.internal/", wsdlLocation = "META-INF/wsdl/Service.wsdl")
    ...
    extends javax.xml.ws.Service
{
    ...
    private final static QName SERVICE_QNAME = new QName("http://accountapiv2.internal/", "Service");

    static {
        SERVICE_WSDL_LOCATION = internal.accountapiv2.Service.class.getClassLoader().getResource("META-INF/wsdl/Service.wsdl");
    ...
    public ServiceSoap getServiceSoap() {
        return super.getPort(new QName("http://accountapiv2.internal/", "ServiceSoap"), ServiceSoap.class);
    }
    ...
    public ServiceSoap getServiceSoap(WebServiceFeature... features) {
        return super.getPort(new QName("http://accountapiv2.internal/", "ServiceSoap"), ServiceSoap.class, features);
    }
