 ...
 * 
 */
@WebServiceClient(name = "DictionaryService", targetNamespace = "http://ss.yahooapis.jp/V5", wsdlLocation = "META-INF/wsdl/DictionaryService.wsdl")
    ...
    extends Service
{
    ...
    static {
        DICTIONARYSERVICE_WSDL_LOCATION = jp.yahooapis.ss.v5.DictionaryService.class.getClassLoader().getResource("META-INF/wsdl/DictionaryService.wsdl");
        WebServiceException e = null;
        if (DICTIONARYSERVICE_WSDL_LOCATION == null) {
            e = new WebServiceException("Cannot find 'META-INF/wsdl/DictionaryService.wsdl' wsdl. Place the resource correctly in the classpath.");
        }
