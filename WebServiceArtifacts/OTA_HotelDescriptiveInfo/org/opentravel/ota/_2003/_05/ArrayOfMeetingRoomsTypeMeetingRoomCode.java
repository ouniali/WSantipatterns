...
public class ArrayOfMeetingRoomsTypeMeetingRoomCode {
    ...
    protected List<ArrayOfMeetingRoomsTypeMeetingRoomCode.Code> code;
     ...
     * {@link ArrayOfMeetingRoomsTypeMeetingRoomCode.Code }
     * 
     * 
     */
    public List<ArrayOfMeetingRoomsTypeMeetingRoomCode.Code> getCode() {
        if (code == null) {
            code = new ArrayList<ArrayOfMeetingRoomsTypeMeetingRoomCode.Code>();
        }
        return this.code;
    }
