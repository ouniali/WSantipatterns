 ...
 * 
 */
@WebServiceClient(name = "Weather", targetNamespace = "http://ws.cdyne.com/WeatherWS/", wsdlLocation = "META-INF/wsdl/13773_United_States_Weather.wsdl")
    ...
    extends Service
{
    ...
    static {
        WEATHER_WSDL_LOCATION = com.cdyne.ws.weatherws.Weather.class.getClassLoader().getResource("META-INF/wsdl/13773_United_States_Weather.wsdl");
        WebServiceException e = null;
        if (WEATHER_WSDL_LOCATION == null) {
            e = new WebServiceException("Cannot find 'META-INF/wsdl/13773_United_States_Weather.wsdl' wsdl. Place the resource correctly in the classpath.");
        }
        WEATHER_EXCEPTION = e;
    }
