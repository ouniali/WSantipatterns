...
public class IHotelFlowSearchHotelsWSFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public IHotelFlowSearchHotelsWSFaultFaultMessage(String message, WSFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public IHotelFlowSearchHotelsWSFaultFaultMessage(String message, WSFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
