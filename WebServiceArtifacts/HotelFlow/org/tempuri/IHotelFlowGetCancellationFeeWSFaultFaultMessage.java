...
public class IHotelFlowGetCancellationFeeWSFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public IHotelFlowGetCancellationFeeWSFaultFaultMessage(String message, WSFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public IHotelFlowGetCancellationFeeWSFaultFaultMessage(String message, WSFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
