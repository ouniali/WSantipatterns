...
public class IHotelFlowGetRGInfoWSFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public IHotelFlowGetRGInfoWSFaultFaultMessage(String message, WSFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public IHotelFlowGetRGInfoWSFaultFaultMessage(String message, WSFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
