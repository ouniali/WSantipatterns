...
public class IHotelFlowCostAmendWSFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public IHotelFlowCostAmendWSFaultFaultMessage(String message, WSFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public IHotelFlowCostAmendWSFaultFaultMessage(String message, WSFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
