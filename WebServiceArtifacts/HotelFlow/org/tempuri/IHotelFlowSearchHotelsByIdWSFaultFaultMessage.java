...
public class IHotelFlowSearchHotelsByIdWSFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public IHotelFlowSearchHotelsByIdWSFaultFaultMessage(String message, WSFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public IHotelFlowSearchHotelsByIdWSFaultFaultMessage(String message, WSFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
