...
public class IHotelFlowBookHotelV3WSFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public IHotelFlowBookHotelV3WSFaultFaultMessage(String message, WSFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public IHotelFlowBookHotelV3WSFaultFaultMessage(String message, WSFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
