...
public class IHotelFlowDoAmendWSFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public IHotelFlowDoAmendWSFaultFaultMessage(String message, WSFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public IHotelFlowDoAmendWSFaultFaultMessage(String message, WSFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
