...
public class ObjectFactory {
    ...
    /**
     * Create an instance of {@link SecuritySoapHeader }
     * 
     */
    public SecuritySoapHeader createSecuritySoapHeader() {
        return new SecuritySoapHeader();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link SecuritySoapHeader }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd", name = "Security")
    public JAXBElement<SecuritySoapHeader> createSecurity(SecuritySoapHeader value) {
        return new JAXBElement<SecuritySoapHeader>(_Security_QNAME, SecuritySoapHeader.class, null, value);
    }
