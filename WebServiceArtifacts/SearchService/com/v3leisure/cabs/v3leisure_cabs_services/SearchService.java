 ...
 * 
 */
@WebServiceClient(name = "SearchService", targetNamespace = "http://www.v3leisure.com/CABS/V3Leisure.CABS.Services.WebServices", wsdlLocation = "META-INF/wsdl/SearchService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName SEARCHSERVICE_QNAME = new QName("http://www.v3leisure.com/CABS/V3Leisure.CABS.Services.WebServices", "SearchService");

    static {
        SEARCHSERVICE_WSDL_LOCATION = com.v3leisure.cabs.v3leisure_cabs_services.SearchService.class.getClassLoader().getResource("META-INF/wsdl/SearchService.wsdl");
    ...
    public SearchServiceSoap getSearchServiceSoap() {
        return super.getPort(new QName("http://www.v3leisure.com/CABS/V3Leisure.CABS.Services.WebServices", "SearchServiceSoap"), SearchServiceSoap.class);
    }
    ...
    public SearchServiceSoap getSearchServiceSoap(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.v3leisure.com/CABS/V3Leisure.CABS.Services.WebServices", "SearchServiceSoap"), SearchServiceSoap.class, features);
    }
