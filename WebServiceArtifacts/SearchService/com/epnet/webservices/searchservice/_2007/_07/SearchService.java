 ...
 * 
 */
@WebServiceClient(name = "SearchService", targetNamespace = "http://epnet.com/webservices/SearchService/2007/07/", wsdlLocation = "META-INF/wsdl/SearchService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName SEARCHSERVICE_QNAME = new QName("http://epnet.com/webservices/SearchService/2007/07/", "SearchService");

    static {
        SEARCHSERVICE_WSDL_LOCATION = com.epnet.webservices.searchservice._2007._07.SearchService.class.getClassLoader().getResource("META-INF/wsdl/SearchService.wsdl");
    ...
    public SearchServiceSoap getSearchServiceSoap() {
        return super.getPort(new QName("http://epnet.com/webservices/SearchService/2007/07/", "SearchServiceSoap"), SearchServiceSoap.class);
    }
    ...
    public SearchServiceSoap getSearchServiceSoap(WebServiceFeature... features) {
        return super.getPort(new QName("http://epnet.com/webservices/SearchService/2007/07/", "SearchServiceSoap"), SearchServiceSoap.class, features);
    }
