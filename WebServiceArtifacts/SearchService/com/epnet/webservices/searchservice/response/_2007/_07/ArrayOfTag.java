 ...
 *       &lt;sequence>
 *         &lt;element name="dbTag" type="{http://epnet.com/webservices/SearchService/Response/2007/07/}Tag" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfTag {
     ...
     * 
     */
    public List<Tag> getDbTag() {
        if (dbTag == null) {
            dbTag = new ArrayList<Tag>();
        }
        return this.dbTag;
    }
