...
@XmlType(name = "Insurances", propOrder = {
    "insuranceAmount",
    "insuranceCompany",
    "insuranceFactor",
    "serviceType",
    ...
    extends OutputMethods
{
    ...
    @XmlElementRef(name = "serviceType", namespace = "http://faresearch_output.output.faresearch.v_1_3.services.inforcyl.com/xsd", type = JAXBElement.class, required = false)
