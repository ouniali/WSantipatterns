 ...
 * 
 */
@WebServiceClient(name = "GeoIPService", targetNamespace = "http://www.webservicex.net/", wsdlLocation = "META-INF/wsdl/GeoIPService.wsdl")
    ...
    extends Service
{
    ...
    static {
        GEOIPSERVICE_WSDL_LOCATION = net.webservicex.GeoIPService.class.getClassLoader().getResource("META-INF/wsdl/GeoIPService.wsdl");
        WebServiceException e = null;
        if (GEOIPSERVICE_WSDL_LOCATION == null) {
            e = new WebServiceException("Cannot find 'META-INF/wsdl/GeoIPService.wsdl' wsdl. Place the resource correctly in the classpath.");
        }
