...
/**
 * <p>Java class for filteredDeviceListResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="filteredDeviceListResponse">
 *   &lt;complexContent>
 ...
 *         &lt;element name="deviceList" type="{http://ws.gdsp.vodafone.com/}tDeviceList" maxOccurs="100" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "filteredDeviceListResponse", propOrder = {
    "returnCode",
    "matchedResults",
    "deviceList"
})
public class FilteredDeviceListResponse {

    protected ReturnCode returnCode;
    protected long matchedResults;
    @XmlElement(nillable = true)
    protected List<TDeviceList> deviceList;
     ...
     * 
     */
    public List<TDeviceList> getDeviceList() {
        if (deviceList == null) {
            deviceList = new ArrayList<TDeviceList>();
        }
