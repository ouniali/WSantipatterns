...
/**
 * <p>Java class for atributosFolletosType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="atributosFolletosType">
 *   &lt;complexContent>
 ...
 *         &lt;element name="listaAtributos" type="{types.hotel.wst}atributoFolletoType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "atributosFolletosType", propOrder = {
    "nombreOpcion",
    "contenido",
    "listaAtributos"
})
public class AtributosFolletosType {

    protected String nombreOpcion;
    protected List<ContenidoFolletoType> contenido;
    protected List<AtributoFolletoType> listaAtributos;
    ...
    /**
     * Gets the value of the listaAtributos property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the listaAtributos property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getListaAtributos().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<AtributoFolletoType> getListaAtributos() {
        if (listaAtributos == null) {
            listaAtributos = new ArrayList<AtributoFolletoType>();
        }
