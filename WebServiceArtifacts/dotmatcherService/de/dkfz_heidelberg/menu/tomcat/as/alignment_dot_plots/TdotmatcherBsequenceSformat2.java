...
/**
 * <p>Java class for TdotmatcherBsequenceSformat2.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="TdotmatcherBsequenceSformat2">
 ...
 * 
 */
@XmlType(name = "TdotmatcherBsequenceSformat2")
@XmlEnum
public enum TdotmatcherBsequenceSformat2 {
    ...
    TdotmatcherBsequenceSformat2(String v) {
        value = v;
    }
    ...
    public static TdotmatcherBsequenceSformat2 fromValue(String v) {
        for (TdotmatcherBsequenceSformat2 c: TdotmatcherBsequenceSformat2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
