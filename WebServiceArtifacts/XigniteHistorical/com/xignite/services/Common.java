...
@XmlSeeAlso({
    ExtendedDividendHistory.class,
    HistoricalQuotes.class,
    SplitHistory.class,
    AdvancesAndDeclines.class,
    DividendHistory.class,
    HistoricalQuote.class,
    SplitRatio.class,
    HistoricalHighLow.class,
    HistoricalStatistics.class,
    CompleteDividendHistory.class,
    SymbolList.class,
    Security.class,
    Dividend.class,
    TopByCapitalization.class,
    Top.class
})
public class Common {
