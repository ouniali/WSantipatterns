...
public class ArrayOfServicesTypeService {
    ...
    protected List<ArrayOfServicesTypeService.ServicesTypeService> servicesTypeService;
     ...
     * {@link ArrayOfServicesTypeService.ServicesTypeService }
     * 
     * 
     */
    public List<ArrayOfServicesTypeService.ServicesTypeService> getServicesTypeService() {
        if (servicesTypeService == null) {
            servicesTypeService = new ArrayList<ArrayOfServicesTypeService.ServicesTypeService>();
        }
