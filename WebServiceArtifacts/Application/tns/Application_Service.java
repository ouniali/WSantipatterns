 ...
 * 
 */
@WebServiceClient(name = "Application", targetNamespace = "tns", wsdlLocation = "META-INF/wsdl/prolific.wsdl")
    ...
    extends Service
{
    ...
    static {
        APPLICATION_WSDL_LOCATION = tns.Application_Service.class.getClassLoader().getResource("META-INF/wsdl/prolific.wsdl");
        WebServiceException e = null;
        if (APPLICATION_WSDL_LOCATION == null) {
            e = new WebServiceException("Cannot find 'META-INF/wsdl/prolific.wsdl' wsdl. Place the resource correctly in the classpath.");
        }
