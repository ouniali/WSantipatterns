 ...
 *         &lt;element name="CompoundOrigins" type="{http://www.ebi.ac.uk/webservices/chebi}CompoundOrigins" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Entity {
    ...
    /**
     * Gets the value of the compoundOrigins property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the compoundOrigins property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCompoundOrigins().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CompoundOrigins }
     * 
     * 
     */
    public List<CompoundOrigins> getCompoundOrigins() {
        if (compoundOrigins == null) {
            compoundOrigins = new ArrayList<CompoundOrigins>();
        }
