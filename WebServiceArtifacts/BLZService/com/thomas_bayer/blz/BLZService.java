 ...
 * 
 */
@WebServiceClient(name = "BLZService", targetNamespace = "http://thomas-bayer.com/blz/", wsdlLocation = "META-INF/wsdl/BLZService.wsdl")
    ...
    extends Service
{
    ...
    static {
        BLZSERVICE_WSDL_LOCATION = com.thomas_bayer.blz.BLZService.class.getClassLoader().getResource("META-INF/wsdl/BLZService.wsdl");
        WebServiceException e = null;
        if (BLZSERVICE_WSDL_LOCATION == null) {
            e = new WebServiceException("Cannot find 'META-INF/wsdl/BLZService.wsdl' wsdl. Place the resource correctly in the classpath.");
        }
